...
if [ $EXIT_CODE -eq 0 ]; then
  ...
  echo ""
  echo -e "  ${BOLD}DO NOT:${RESET}"
  echo "  - Commit .env to git (it holds production secrets)"
  echo "  - Share .env via email or Slack (use 1Password)"
  echo "  - Reuse these credentials for other projects"
fi
echo ""
