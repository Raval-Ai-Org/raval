...
- **Approval boundary holds** (CLAUDE.md 4.3): the engine publishes, schedules, and retries — it never *decides* to publish. Approval is a platform concern enforced before `/api/v1/publish` is called.
