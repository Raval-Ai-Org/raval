...
```json
{ "error": { "code": "PLATFORM_VALIDATION | ACCOUNT_EXPIRED | SDR_UNREACHABLE | DUPLICATE | ...", "detail": "human-readable", "requestId": "..." } }
```
