...
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **Mellox chat copilot**            | [route.ts](src/app/api/chat/route.ts), [ChatPanel.tsx](src/components/app/ChatPanel.tsx)                                        | Live — SSE streaming, action tags (`[[action:…]]`) the UI parses and executes |
