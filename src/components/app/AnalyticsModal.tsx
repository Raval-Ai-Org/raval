                ...
                >
                  <VisuallyHidden>
                    ...
                    <DialogPrimitive.Description>
                      Analytics for your workspace from Mellox, Google Analytics 4, Google Search
                      Console and the Mellox AI Visibility scan.
                    </DialogPrimitive.Description>
                  </VisuallyHidden>
                    ...
                    <div className="flex min-w-0 items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-0.5 text-[11px] text-muted-foreground">
                          Mellox, Google Analytics, Search Console and AI Visibility
                        </div>
                      </div>
                    </div>
