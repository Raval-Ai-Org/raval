...
export const agents: Record<string, Agent> = {
  scout: {
    ...
    description:
      "Optimizes your brand for AI search — ChatGPT, Gemini, Perplexity, Claude and classic SERPs.",
    emoji: "🔍",
    defaultMood: "scanning",
    activeMood: "scanning",
    accentHue: 217,
    status: {
      idle: "Watching AI engines…",
    ...
    missions: [
      {
        id: "scout-aeo",
        label: "Audit AEO presence",
        description: "Top 25 AI prompts",
        durationSec: 22,
      },
      {
        id: "scout-geo",
        label: "Map GEO citations",
        description: "Across 5 engines",
        durationSec: 45,
      },
      {
        id: "scout-deep",
        label: "Deep crawl",
        description: "Long-tail expansion",
        durationSec: 60,
      },
    ],
  },
