import {
  Linkedin, Twitter, Instagram, Facebook, Youtube, MessageCircle, Music2,
  type LucideIcon,
...
export const PLATFORMS: Record<PlatformId, PlatformSpec> = {
  linkedin: {
    ...
    maxChars: 3000, optimalChars: 1300, hashtags: [3, 5],
    style:
  ...
  twitter: {
    ...
    maxChars: 280, optimalChars: 240, hashtags: [0, 2],
    style:
  ...
  instagram: {
    ...
    maxChars: 2200, optimalChars: 150, hashtags: [8, 12],
    style:
  ...
  facebook: {
    ...
    maxChars: 2000, optimalChars: 450, hashtags: [1, 3],
    style:
  ...
  threads: {
    id: "threads", label: "Threads", icon: MessageCircle, color: "#000000",
    maxChars: 500, optimalChars: 380, hashtags: [0, 1],
    style:
  ...
  tiktok: {
    ...
    maxChars: 2200, optimalChars: 150, hashtags: [4, 8],
    style:
  ...
  youtube: {
    ...
    maxChars: 1000, optimalChars: 500, hashtags: [3, 5],
    style:
