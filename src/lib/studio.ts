import {
  Share2, Search, LayoutTemplate, Mail, FileText, Palette,
  type LucideIcon,
} from "@/components/ui/gemini-icons";

export type CanvasType =
  | "social-post" | "seo-brief"
  | "landing-page" | "email" | "article" | "design-asset";
...
export const STUDIO_TILES: TileDef[] = [
  { id: "social-post",  label: "Social Post",  sub: "IG · X · LinkedIn",     icon: Share2,         tint: "brand-green" },
  { id: "seo-brief",    label: "SEO Brief",    sub: "SEO · AEO · GEO",       icon: Search,         tint: "sky" },
  { id: "landing-page", label: "Landing Page", sub: "Hero · CTA · sections", icon: LayoutTemplate, tint: "violet" },
  ...
  { id: "design-asset", label: "Design",       sub: "Creatives · brand kit", icon: Palette,        tint: "fuchsia", beta: true },
];

export const TILE_BY_ID: Record<CanvasType, TileDef> =
  STUDIO_TILES.reduce((m, t) => ((m[t.id] = t), m), {} as Record<CanvasType, TileDef>);
...
export const MOCK_SCHEDULED: QueueItem[] = [
  { id: "s1", title: "Weekly newsletter — issue 14",  canvas: "email",       channel: "Resend",   when: "Tomorrow · 9:00" },
  { id: "s2", title: "Product launch carousel",       canvas: "social-post", channel: "Instagram",when: "Thu · 18:00" },
  { id: "s3", title: "AEO brief: 'best CRM for SMB'", canvas: "seo-brief",   channel: "Site",     when: "Fri · 11:00" },
  { id: "s4", title: "Landing page · pricing v2",     canvas: "landing-page",channel: "Site",     when: "Sat · 08:00" },
  { id: "s5", title: "How-to: onboarding in 60s",     canvas: "article",     channel: "Blog",     when: "Mon · 07:00" },
];
